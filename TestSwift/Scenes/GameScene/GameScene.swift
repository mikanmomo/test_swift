...
class GameScene: SKScene {
    ...
    var eggArray:[SKSpriteNode] = []
    var egg2Array:[SKSpriteNode] = []
    
    var action2_S : [SKAction] = []
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 0...4 {
            ...
            let actionS = SKAction.sequence([action1,
                                             ...
                                             action5])
            // actionSをずっと繰り返す
            actionR.append(SKAction.repeatForever(actionS))
            ...
            action2_S.append(SKAction.sequence([action2_1,
                                             action2_2,
                                             action2_3]))
    ...
    @objc func timerUpdate() {
        ...
        if timeCount < 1 {  // もし 0 になったらゲームオーバー
            ...
            eggArray[randomInt].run(actionR[randomInt], completion: {self.egg2Array[randomInt].run(self.action2_S[randomInt])})
        }
    }
}
